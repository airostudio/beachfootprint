...
/** Maps our storefront Address shape to the AliExpress order-placement address DTO. Throws on missing required fields rather than silently placing an undeliverable order. */
