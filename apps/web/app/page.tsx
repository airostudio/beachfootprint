...
export default async function HomePage() {
  const featureCategoryHandles = ["silicone-dolls", "adult-products", "accessories", "care", "new-arrivals", "best-sellers"];
    ...
    <div>
      <section className="relative h-[85vh] min-h-[560px] flex items-end overflow-hidden">
        ...
        <div className="container-page relative pb-16 sm:pb-24 text-warm-50">
          <p className="eyebrow text-stone-300 mb-4">Valley Of The Dolls</p>
      ...
      <section className="bg-ink-950 text-warm-50 py-24">
        <div className="container-page grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <p className="eyebrow text-stone-400 mb-4">Build Your Doll</p>
            <h2 className="font-serif text-4xl mb-6 leading-tight">Design a companion that's entirely yours.</h2>
            <p className="text-stone-300 leading-relaxed mb-8 max-w-md">
              Choose body, skin tone, face, eyes, hair and features step by step, with a live running price the whole way through.
            </p>
            <Link href="/build-your-doll" className="btn-primary bg-warm-50 text-ink-950 hover:bg-stone-200">
              Start Designing
            </Link>
          </div>
          <div className="relative aspect-[4/3] bg-ink-900">
            <Image src="https://picsum.photos/seed/configurator-promo/1000/750" alt="Doll configurator preview" fill className="object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-stone-200 py-16">
        <div className="container-page grid sm:grid-cols-3 gap-10 text-center">
          <div>
            <p className="eyebrow mb-2">Discreet Delivery</p>
            <p className="text-sm text-stone-500">Plain packaging, no exterior branding, on every order.</p>
          </div>
          <div>
            <p className="eyebrow mb-2">Body-Safe Materials</p>
            <p className="text-sm text-stone-500">Medical-grade silicone and TPE across the entire catalogue.</p>
          </div>
          <div>
            <p className="eyebrow mb-2">Considered Support</p>
            <p className="text-sm text-stone-500">Order-based support that never requires unnecessary detail.</p>
          </div>
        </div>
      </section>
    </div>
